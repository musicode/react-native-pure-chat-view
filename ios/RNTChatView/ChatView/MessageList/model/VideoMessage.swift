...
@objc public class VideoMessage: Message {
    ...
    @objc public init(id: String, user: User, status: MessageStatus, time: String, canShare: Bool, canRecall: Bool, canDelete: Bool, url: String, duration: Int, thumbnail: String, width: Int, height: Int) {
        self.url = url
