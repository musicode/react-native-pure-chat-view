...
@objc public class PostMessage: Message {
    ...
    @objc public init(id: String, user: User, status: MessageStatus, time: String, canShare: Bool, canRecall: Bool, canDelete: Bool, thumbnail: String, title: String, desc: String, label: String, link: String) {
